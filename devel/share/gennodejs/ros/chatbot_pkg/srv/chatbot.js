...
class chatbotRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type chatbotRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type chatbotRequest
    let len;
    let data = new chatbotRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new chatbotRequest(null);
...
class chatbotResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type chatbotResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type chatbotResponse
    let len;
    let data = new chatbotResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new chatbotResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  md5sum() { return 'a27d8629aeefd2b315942fe4a74ab143'; },
  datatype() { return 'chatbot_pkg/chatbot'; }
};
