...
void MyAGV::execute(double linearX, double linearY, double angularZ)
{
    ...
    geometry_msgs::Quaternion odom_quat2 = tf::createQuaternionMsgFromYaw(theta * 1.05);
    geometry_msgs::TransformStamped odom_trans;
    odom_trans.header.stamp = currentTime;
    odom_trans.header.frame_id = "odom";
    odom_trans.child_frame_id = "base_footprint";

    odom_trans.transform.translation.x = x * 1.2; //X
    odom_trans.transform.translation.y = y * 1.2; //Y
