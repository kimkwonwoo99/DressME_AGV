...
bool MyAGV::readSpeed()
{
    ...
    vx = (static_cast<double>(buf[index]) - 128.0) * 0.01 * 1.06;
    vy = (static_cast<double>(buf[index + 1]) - 128.0) * 0.01 * 1.06;
    vtheta = (static_cast<double>(buf[index + 2]) - 128.0) * 0.01 * 1.06;
...
{   
    ...
    odom_trans.transform.translation.x = x * 1.15; 
    odom_trans.transform.translation.y = y * 1.15; 
